...
DEMOGRAPHIC_INFO = {
    'diagnosis_enroll': {
        'files': {
            'Participant_Status.csv': 'COHORT_DEFINITION'
        },
        'replace': {
            'input': {
    ...
    'diagnosis': {
        'files': {
            'Participant_Status.csv': 'CONCOHORT_DEFINITION'
        },
        'replace': {
            'input': {
                "Parkinson's Disease": 'pd',
    ...
    'date_consensus': {
        'files': {
            'Participant_Status.csv': 'CONDATE'
        },
        'apply': {
            'input': pd.to_datetime
        }
    ...
    'status': {
        'files': {
            'Participant_Status.csv': 'ENROLL_STATUS'
        },
        'apply': {
...
PRODROMAL_INFO = {
    'rbd':{
        'files': {'Participant_Status.csv' : 'CONRBD'
        },
    },
    'dat_deficit':{
    ...
    'hyposmia':{
        'files': {'Participant_Status.csv' : 'CONHPSM'
        },
    },
    'phenoconverted':{
        'files': {'Participant_Status.csv' : 'PHENOCNV'
        },
    },
    'phenoconverted_visit':{
        'files': {'Participant_Status.csv' : 'DIAG1VIS'
        },
    },
    'phenoconverted_diagnosis':{
        'files': {'Participant_Status.csv' : 'DIAG1'
        },
    }
}
...
GENOTYPES_INFO = {
    'LRRK2': {
        'files': {
            'Participant_Status.csv': 'CONLRRK2'
        }
    },
    'GBA': {
        'files': {
            'Participant_Status.csv': 'CONGBA'
        }
    },
    'SNCA': {
        'files': {
            'Participant_Status.csv': 'CONSNCA'
        }
    },
        'PRKN': {
        'files': {
            'Participant_Status.csv': 'CONPRKN'
        }
    },
        'PINK1': {
        'files': {
            'Participant_Status.csv': 'CONPINK1'
        }
    },
}
